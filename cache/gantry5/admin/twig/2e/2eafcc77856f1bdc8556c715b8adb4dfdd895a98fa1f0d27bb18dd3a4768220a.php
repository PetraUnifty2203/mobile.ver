...
class __TwigTemplate_1f5708fcb0fbc3481042d40a157b4ad53ee373ea40b230e44d08e6ab360ff3f8 extends \Twig\Template
{
...
($context["gantry"] ?? null), "outlines", []), "title", [0 => $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "outline", [])], "method")) . "</strong>"))) . "<br />ID: ") . $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "atom", [])) . "<br />Replace: ") . twig_join_filter($this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "include", []), ", ")) . "\"")) : (""));
    ...
    {
        return new Source("", "@gantry-admin/pages/configurations/page/atoms.html.twig", "C:\\xampp\\htdocs\\Jommla3\\administrator\\components\\com_gantry5\\templates\\pages\\configurations\\page\\atoms.html.twig");
    }
}
